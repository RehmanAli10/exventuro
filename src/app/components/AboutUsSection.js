...
export default function AboutUsSection() {
  return (
    <section className="bg-gradient-to-br from-[#F0F8FF] to-white text-gray-800 px-4 sm:px-8 lg:px-16 py-20 space-y-20 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {[
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className={`bg-gradient-to-br ${item.color} rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 text-white`}
          >
